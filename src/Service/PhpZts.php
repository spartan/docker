...
class PhpZts extends ServiceAbstract
{
    const DEFAULT_CONFIG = [
        'build'          => [
            'context'    => '.',
            'dockerfile' => 'php_zts.dockerfile',
        ],
        'container_name' => '${DOCKER_STACK}_zts',
        'restart'        => 'always',
        'working_dir'    => '/var/www',
        'volumes'        => [
    ...
    public function config(): array
    {
        ...
        if ($this->flags & self::FLAG_IS_PRODUCTION) {
            $config['build']['dockerfile'] = 'php_zts.production.dockerfile';
        }
